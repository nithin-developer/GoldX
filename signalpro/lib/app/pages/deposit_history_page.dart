...
class _DepositHistoryPageState extends State<DepositHistoryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(l10n.tr('Deposit History')),
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            final message = snapshot.error is ApiException
                ...
                : l10n.tr('Unable to load deposit history.');
              ...
              children: [
                ...
                if (items.isEmpty)
                  EmptyStateIllustration(
                    title: l10n.tr('No Deposit Records'),
                    subtitle: l10n.tr(
    ...
    return GlassCard(
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.tr('Total requested volume for this filter'),
        ...
        children: [
          ...
          Text(
            item.transactionRef?.isNotEmpty == true
                ? l10n.tr(
                    'Ref: {value}',
                    params: <String, String>{'value': item.transactionRef!},
                  )
                : l10n.tr('Ref: Not provided'),
            maxLines: 1,
        ...
        child: GlassCard(
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.tr('Unable to load deposits'),
