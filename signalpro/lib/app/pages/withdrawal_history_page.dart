...
class _WithdrawalHistoryPageState extends State<WithdrawalHistoryPage> {
  ...
  Future<List<WithdrawalHistoryRecord>>? _future;
  ...
  Future<List<WithdrawalHistoryRecord>> _loadHistory() {
    return _walletApi!.getWithdrawalHistory(
      limit: 100,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<WithdrawalHistoryRecord>>(
        future: _future,
        builder: (context, snapshot) {
          ...
          final items = snapshot.data ?? const <WithdrawalHistoryRecord>[];
...
class _WithdrawalHistorySummary extends StatelessWidget {
  const _WithdrawalHistorySummary({
    required this.entries,
    required this.currencyFormatter,
  });

  final List<WithdrawalHistoryRecord> entries;
...
class _WithdrawalHistoryCard extends StatelessWidget {
  ...
  final WithdrawalHistoryRecord item;
